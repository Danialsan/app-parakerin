...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Siswa /</span> Presensi 2</h4>
        <div class="row">
            <!-- Lokasi -->
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        @if (!empty($presensiHariIni) && $presensiHariIni->absensi === 'hadir')
                            ...
                            <form id="update-presensi-form"
                                action="{{ route('siswa.presensi-2.update', $presensiHariIni->id) }}" method="POST"
                                class="d-none">
                                @csrf
                                @method('PUT')
            ...
            <div class="modal fade" id="presensi" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        @if (empty($presensiHariIni))
                            <form action="{{ route('siswa.presensi-2.store') }}" method="post">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <p class="text-danger d-none" id="peringatan-tempat">
                                        Posisi anda tidak sesuai dengan tempat dudi, silahkan sesuaikan untuk absen hadir.
                                    </p>
                                    <div class="mb-3">
    ...
    @push('custom-script')
        <script>
            ...
            function ambilPosisi(position) {
                ...
                @if (!empty($posisi_awal->posisi_masuk))
                    var posisiAwal = [{{ $posisi_awal->posisi_masuk }}];
                    var radius = 80;
