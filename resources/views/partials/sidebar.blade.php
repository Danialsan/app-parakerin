<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (request()->is('dudi*'))
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('dudi/beranda') ? 'active' : '' }}">
                <a href="{{ route('dudi.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
                    <div data-i18n="Analytics">Beranda</div>
                </a>
            </li>
            <!-- Presensi -->
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Absensi Siswa</span>
            </li>
            <li class="menu-item {{ request()->is('dudi/presensi-siswa') ? 'active' : '' }}">
                <a href="{{ route('dudi.presensi-siswa') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bxs-book-content"></i>
                    <div data-i18n="Analytics">Presensi Siswa</div>
                </a>
            </li>
            <li class="menu-item {{ request()->is('dudi/jurnal-siswa') ? 'active' : '' }}">
                <a href="{{ route('dudi.jurnal-siswa') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-notepad"></i>
