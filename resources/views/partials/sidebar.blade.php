<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (request()->is('dudi*'))
            ...
            <li class="menu-item {{ request()->is('dudi/siswa/presensi') ? 'active' : '' }}">
                <a href="{{ route('dudi.presensi') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bxs-book-content"></i>
                    <div data-i18n="Analytics">Presensi Siswa</div>
                </a>
            </li>
            <li class="menu-item {{ request()->is('dudi/siswa/jurnal') ? 'active' : '' }}">
                <a href="{{ route('dudi.jurnal') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-list-check"></i>
                    <div data-i18n="Analytics">Jurnal Siswa</div>
                </a>
            </li>
