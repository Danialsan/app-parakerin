    ...
    <div class="row">
      ...
      @if (isset($pengaturan_pkl))
        ...
        <div class="col-12 col-lg-6 order-2 order-md-3 order-lg-2 mb-4">
          <div class="card">
            <h5 class="card-header">Presensi Hari Ini</h5>
            <div class="table-responsive text-nowrap">
              ...
              @else
                <button id="btn-absensi" class="btn btn-primary ms-4" data-bs-toggle="modal" data-bs-target="#presensi"
                  onclick="waktu()">
                  <i class='bx {{ empty($presensiHariIni) ? 'bxs-user' : 'bxs-user-check' }}'></i>
                  Masuk</button>
              @endif

              @if (!empty($presensiHariIni) && $presensiHariIni->absensi === 'hadir')
                <button onclick="absensiPulang(event);" class="btn btn-danger
                                ms-3"
                  {{ $presensiHariIni->waktu_pulang != null ? 'disabled' : '' }}>
                  <i class='bx bx-home'></i> Pulang</button>
                <form id="update-presensi-form" action="{{ route('siswa.presensi.update', $presensiHariIni->id) }}"
                ...
                <form action="{{ route('siswa.presensi.store') }}" method="post">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-control" name="absensi" id="absensi" onchange="presensi()">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnAbsensi" style="display: none">
                      Absensi
                    </button>
                  </div>
                </form>
